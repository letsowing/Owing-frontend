  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-between">
        <label className="font-semibold dark:text-white">이미지</label>
      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-darkgray dark:text-white">
            AI를 활용하여 이미지를 생성할 수 있어요!
          </span>
        </div>
        <span className="mx-2 rounded-full bg-orange bg-opacity-20 px-2 text-sm text-redorange dark:text-blue">
          Click
        </span>
      </div>
    </div>
