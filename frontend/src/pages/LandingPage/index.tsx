    ...
    <div className="min-h-screen w-full">
      <div className="mx-auto px-4 py-8 sm:py-16">
        <img
          ...
          alt="OwingLogo"
          className="mx-auto mb-12 mt-4 h-auto w-32 sm:mb-24 sm:mt-8 sm:w-64 lg:mb-32 lg:mt-16 lg:w-96"
        />
        ...
        <div className="bg-gradient-to-b from-white to-[#FDF8F4]">
          <h1 className="mb-12 text-center text-2xl font-bold text-darkgray sm:mb-16 sm:text-3xl lg:mb-20 lg:text-4xl">
            이야기 관리를 편하게.
            <br />
            창작의 본질에 집중할 수 있는
            <br />
          ...
          <div className="relative w-full pb-40">
            ...
            <div className="container relative z-20 mx-auto px-4 pt-24 sm:pt-20 lg:pt-72">
        ...
        <h2 className="mb-16 mt-16 text-center text-lg font-bold text-darkgray sm:mb-24 sm:mt-24 sm:text-xl lg:mb-32 lg:mt-32 lg:text-2xl">
        ...
        <div className="bg-[#FAFBFC]">
          ...
          >
            ...
            <h2 className="text-1xl mb-20 ml-20 font-bold text-[#999999]">
              “ 새로 추가되는 이야기와 설정에 <br />
              오류가 있지 않을까? ”<br />
              <br />
